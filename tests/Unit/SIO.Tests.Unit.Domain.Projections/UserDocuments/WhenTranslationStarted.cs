...
{
    public class WhenTranslationStarted : Specification<UserDocumentsProjection>
    {
        ...
        public void ThenUserDocumentsShouldHaveDocumentWithCorrectCondition()
        {
            ...
            document.Condition.Should().Be(DocumentCondition.TranslationStarted);
        }
        ...
        public void ThenUserDocumentsShouldHaveCorrectVersion()
        {
            ...
            userDocuments.Version.Should().Be(4);
        }
    }
}
