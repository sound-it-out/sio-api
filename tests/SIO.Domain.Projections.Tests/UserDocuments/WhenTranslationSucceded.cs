...
{
    public class WhenTranslationSucceded : Specification<UserDocumentsProjection>
    {
        ...
        protected override IEnumerable<IEvent> Given()
        {
            ...
            yield return new TranslationSucceded(_translationId, _documentId, _userId, 4);
        }
        ...
        public void ThenUserDocumentsShouldHaveDocumentWithCorrectCondition()
        {
            ...
            document.Condition.Should().Be(DocumentCondition.TranslationSucceded);
        }
