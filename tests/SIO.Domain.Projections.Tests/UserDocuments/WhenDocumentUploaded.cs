...
{
    public class WhenDocumentUploaded : Specification<UserDocumentsProjection>
    {
        ...
        public void ThenUserDocumentsShouldHaveDocumentWithCorrectCondition()
        {
            ...
            document.Condition.Should().Be(DocumentCondition.Uploaded);
        }
        ...
        public void ThenUserDocumentsShouldHaveCorrectVersion()
        {
            ...
            userDocuments.Version.Should().Be(2);
        }
    }
}
