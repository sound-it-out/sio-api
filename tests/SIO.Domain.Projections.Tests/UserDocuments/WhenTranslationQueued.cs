...
{
    public class WhenTranslationQueued : Specification<UserDocumentsProjection>
    {
        ...
        public void ThenUserDocumentsShouldHaveDocumentWithCorrectCondition()
        {
            ...
            document.Condition.Should().Be(DocumentCondition.TranslationQueued);
        }
        ...
        public void ThenUserDocumentsShouldHaveCorrectVersion()
        {
            ...
            userDocuments.Version.Should().Be(3);
        }
    }
}
